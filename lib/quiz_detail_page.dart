...
import 'dart:async';
import 'package:prantoapp/questions.dart';
...
class _QuizDetailPageState extends State<QuizDetailPage>
  ...
  void _shareScore(String platform) {
    final text = Uri.encodeComponent(
        'I scored $_totalScore in the Level ${widget.level} Quiz on PrantoApp! Can you beat my score?');
    final url = platform == 'facebook'
